...
var API = {
    ...
    step: function step() {
        if (arguments.length > 0 && (arguments.length <= 0 ? undefined : arguments[0]) !== undefined) {
            if ((arguments.length <= 0 ? undefined : arguments[0]) > 100) {
                throw new Error('Maximum progress size is 100. You can not set progress value bigger than 100');
            }
            position = arguments.length <= 0 ? undefined : arguments[0];
        } else {
            position += 10;
        }
